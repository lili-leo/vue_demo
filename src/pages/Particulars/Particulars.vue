<template>
  <div>
    <div class="par-wrap">
      ...
      <!--说两句-->
      <div class="say">
        <textarea class="says" id="" placeholder="说两句吧..." cols="30" rows="10">

        </textarea>
      </div>
      <el-row>
        <el-button type="warning" round>发表</el-button>
      </el-row>
      <!--评论-->
      ...
      <!--相关推荐-->
      <div class="particulars-recommend">
